...
// 生成SM2密钥对
- (NSDictionary *)sm2Generatekey;

// sm2加密
JSExportAs(sm2Encode,
-(NSString *)sm2Encode:(NSString*)data pubkey:(NSString*)publickey
);

//sm2解密
JSExportAs(sm2Decode,
-(NSString *)sm2Decode:(NSString*)data privkey:(NSString*)privkey
);

//sm3加签
JSExportAs(sm3Encode,
-(NSString*)sm3Encode:(NSString*)data
);

//sm4加密 ecb
JSExportAs(sm4Encode,
-(NSString *)sm4Encode:(NSString*)data :(NSString*)pubkey
);

//sm4解密 ecb
JSExportAs(sm4Decode,
-(NSString *)sm4Decode:(NSString*)data :(NSString*)pubkey
);

//sm4加密 cbc
JSExportAs(sm4cbcEncode,
-(NSString *)sm4cbcEncode:(NSString*)data :(NSString*)pubkey iv:(NSString *)iv
);

//sm4加密 cbc
JSExportAs(sm4cbcDataEncode,
- (NSData *)sm4cbcDataEncode:(NSData *)data :(NSString*)pubkey iv:(NSString *)iv
);

//sm4解密 cbc
JSExportAs(sm4cbcDecode,
- (NSString *)sm4cbcDecode:(NSString *)data :(NSString*)pubkey iv:(NSString *)iv
);

//sm4解密 cbc
JSExportAs(sm4cbcDataDecode,
- (NSData *)sm4cbcDataDecode:(NSData *)data :(NSString*)pubkey iv:(NSString *)iv
);

//url编码
JSExportAs(urlEncode,
-(NSString *)urlEncode:(NSString *)data
);

//url解码
JSExportAs(urlDecode,
